...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun registerUser() {
        ...
        if(username.isNotBlank() && email.isNotBlank() && password.isNotBlank() && gender.isNotBlank() &&
            ...
            val registerCredentials = RegisterCredentials(username, email, password, age, gender, weight, height, plan)
                ...
                override fun onResponse(call: Call<RegisterResponse>, response: Response<RegisterResponse>) {
                    ...
                    if(response.isSuccessful) {
                        ...
                        if(responseBody?.error == false) {
                            ...
                            Toast.makeText(this@RegisterActivity, responseBody?.message ?: "Unknown error", Toast.LENGTH_SHORT).show()
                        }
                    } else {
    ...
    private fun setupSpinnerDietPlan() {
        val dietPlanOptions = arrayOf("defisit", "bulking", "None")
